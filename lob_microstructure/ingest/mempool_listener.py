...
from lob_microstructure.models import PendingTx, AgentOrder
from lob_microstructure.actor.wallet_profiler import ETH_USD
from lob_microstructure.decode.tx_decoder import UNISWAP_V2_ROUTER, UNISWAP_V3_ROUTER, WETH
...
def order_to_pending_tx(order: AgentOrder) -> PendingTx:
    ...
    `lob_microstructure/actor/agent_profiles.py`'deki aktör profilleriyle tutarlıdır:
    ...
    üzerinden okur (bkz. `lob_microstructure/decode/tx_decoder.py::_decode_v2`).
    """
